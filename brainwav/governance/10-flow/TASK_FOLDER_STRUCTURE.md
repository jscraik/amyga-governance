...
└── [feature-name]/              # Use descriptive slugs: copilot-enhancement, brainwav-integration
    ...
    │   └── reuse-evaluation.md # Filled from governance/templates/reuse-evaluation-template.md
...
- `analysis/reuse-evaluation.md` - Reuse-first investigation log (template: `governance/templates/reuse-evaluation-template.md`) covering candidates assessed, decisions, evidence links, and mitigation tickets.
...
- `governance/rules/agentic-coding-workflow.md`
