...
| Feature | Description |
| --- | --- |
| ArcTDD + Phase Machine | G0–G10 gates with R→G→F→REVIEW workflow |
...
- [Introduction](./introduction.md) – Framework purpose and philosophy
- [Getting Started](./getting-started.md) – Bootstrap steps for adopting the framework
- [Architecture](./architecture.md) – Governance structure and document hierarchy
- [Glossary](./glossary.md) – Terminology reference

### Workflows & Processes

- [Task Management Guide](./task-management-guide.md) – Enhanced task workflow
- [Cortex Aegis MCP](./cortex-aegis.md) – Oversight gate installation and usage
- [Policies](./policies.md) – Policy configuration for governance gates
...
- [Configuration](./configuration.md) – Environment and MCP configuration
- [Testing & QA](./testing-qa.md) – Test requirements and coverage gates
- [Troubleshooting](./troubleshooting.md) – Common issues and solutions
- [Best Practices](./best-practices.md) – Recommended patterns

### Reference

- [CLI Reference](./cli-reference.md) – Governance command scripts
