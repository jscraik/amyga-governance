...
Explain what the agentic governance framework lets you do when you connect frontier tools (Claude Code, Gemini CLI, Qwen CLI, Codex CLI) in a governed, deterministic way via ASBR.
...
- governance framework hosts the bus (ASBR).
