# governance framework Runtime Map (ASBR-hosted)
...
- Filesystem writes restricted to `/var/cortex/tmp` and `.governance/tmp`
...
## External Integration Map
         ...
         External Clients / Tools                            governance framework (ASBR-hosted)
